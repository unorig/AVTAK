...
D:\OneDrive\C64\Tools\exomizer.exe sfx $43b0 -x 1 "D:\OneDrive\C64\Disassembly\AVTAK\2 Paris\Level2compiled.prg" -o "D:\OneDrive\C64\Disassembly\AVTAK\2 Paris\Level2packed.prg" -p 1
