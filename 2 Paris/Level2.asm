...
var_BondCarXPosLow      = $0338
var_BondCarXPosHigh     = $0339
...
MaydayXMap              = $6900
SpritePointerArray      = $6920
MaydayDirection         = $6930
MaydayYMap              = $6980
MaydayPathCounter       = $69F8
...
* = $4500
            ...
            .include "UpdateScrDamageSpeedo.asm"
...
l_4606
                    ...
                    ADC V_MapXposition                       ; (4618) Add with Carry $033C
                    STA $AE                         ; (461B) Store A to $AE
                    LDA V_MapYposition                       ; (461D) Load A with $033D
...
l_4627
                    ...
                    LDA V_MapXposition                       ; (4628) Load A with $033C
                    SBC #$7E                        ; (462B) Subtract with Carry #$7E (126 / 01111110)
                    STA $AE                         ; (462D) Store A to $AE
                    LDA V_MapYposition                       ; (462F) Load A with $033D
...
l_4639
                    ...
                    ADC V_MapXposition                       ; (4643) Add with Carry $033C
                    STA $AE                         ; (4646) Store A to $AE
                    LDA V_MapYposition                       ; (4648) Load A with $033D
...
l_4804
                    ...
                    STA $0459,X                     ; (4813) Store A to $0459,X$6980,X
...
l_4895
                    ...
                    SBC var_BondCarXPosLow                       ; (4898) Subtract with Carry $0338
...
l_51BB
                    STA CarSpeed                       ; (51BB) Store A to $0340
...
l_5A66
                    JSR l_4290                      ; (5A66) 
                    JSR Sub_UpdateScrDamageSpeedo   ; (5A69) Update damage bar and speedo.
...
l_5C1E
                    ...
                    LDA var_BondCarXPosLow                       ; (5C22) Load A with $0338
...
l_5CBE
                    ...
                    ADC V_MapXposition                       ; (5CD2) Add with Carry $033C
                    STA V_MapXposition                       ; (5CD5) Store A to $033C
...
l_5CED
                    ...
                    LDA V_MapXposition                       ; (5CEE) Load A with $033C
                    SBC #$01                        ; (5CF1) Subtract with Carry #$01 (1 / 00000001)
                    STA V_MapXposition                       ; (5CF3) Store A to $033C
                    BCS l_5CFB                      ; (5CF6) Branch if Carry Set $5CFB
                    DEC V_MapYposition                       ; (5CF8) Decrement $033D
...
l_5D08
                    ...
                    ADC V_MapXposition                       ; (5D1C) Add with Carry $033C
                    STA V_MapXposition                       ; (5D1F) Store A to $033C
...
l_5D37
                    ...
                    LDA V_MapXposition                       ; (5D38) Load A with $033C
                    SBC #$7E                        ; (5D3B) Subtract with Carry #$7E (126 / 01111110)
                    STA V_MapXposition                       ; (5D3D) Store A to $033C
                    BCS l_5D45                      ; (5D40) Branch if Carry Set $5D45
                    DEC V_MapYposition                       ; (5D42) Decrement $033D
...
l_5D52
                    ...
                    LDA V_MapXposition                       ; (5D5E) Load A with $033C
                    STA $5D6D                       ; (5D61) Store A to $5D6D
                    LDA V_MapYposition                       ; (5D64) Load A with $033D
...
l_5DA0
                    ...
                    LDA CarSpeed                       ; (5DAB) Load A with $0340
